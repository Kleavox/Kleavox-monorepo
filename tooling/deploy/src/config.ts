...
export function productionConfigs(
  ...
  return {
    ...
    link: {
      ...
      r2_buckets: [{ binding: "FILES", bucket_name: env.DROP_BUCKET_NAME }],
      ratelimits: [
        rateLimit("PUBLIC_CREATE_RATE_LIMIT", "3201", 10),
        rateLimit("REPORT_RATE_LIMIT", "3202", 5),
