...
<head>
  ...
  <style>
    *{box-sizing:border-box}
    ...
    small{display:block;margin-bottom:18px;color:${LINK_ACCENT};font-family:"Cascadia Code",Consolas,monospace;font-size:0.66rem;font-weight:700;letter-spacing:0.16em;text-transform:uppercase}
    ...
    input:focus{border-color:${LINK_ACCENT};outline:none}
    button{margin-top:12px;border:0;background:${LINK_ACCENT};color:#031620;font-weight:800;cursor:pointer}
